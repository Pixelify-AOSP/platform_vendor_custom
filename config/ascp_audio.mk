...
ALARM_PATH := vendor/custom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/custom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/custom/prebuilt/common/media/audio/ringtones
